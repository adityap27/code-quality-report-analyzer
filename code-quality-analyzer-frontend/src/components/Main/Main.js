...
const Main = () => {
  ...
  const executeAnalysis = () => {
    setIsLoading(true);
    // Construct the request data as a JavaScript object
          ...
          <>
            ...
            <div className="overlay">
              <div className="overlay__inner">
                ...
                <button className="overlay__btn overlay_btn--transparent" onClick={fetchBranches}>
                  Fetch Branches
                </button>
                  ...
                  <>
                    <div className="dropdowns" style={{ display: "flex" }}>
                      ...
                      <Select
                        ...
                        placeholder="Search and select a commit..."
                      />
                    </div>
                    <div className="overlay__btns">
                      <button className="overlay__btn" onClick={executeAnalysis}>
                        Execute
                      </button>
                    </div>
                  </>
