...
const Main = () => {
  ...
  const validateRepoUrl = () => {
    if (!repoLink.match(/^(https:\/\/|http:\/\/)?(www\.)?github\.com\/[a-zA-Z0-9_.-]+\/[a-zA-Z0-9_.-]+/)) {
      setErrorMessage("Please enter a valid GitHub repository link (e.g., https://github.com/username/repo)");
      return false;
    }
    setErrorMessage('');
    return true;
    ...
    if (validateRepoUrl()) {
      ...
      axios
        ...
        .then((response) => {
          ...
          const defaultBranch = branchOptions.find((branch) => branch.value === "main") || branchOptions.find((branch) => branch.value === "master");
          if (defaultBranch) {
  ...
  const executeAnalysis = () => {
    ...
    axios.post('http://localhost:8080/onecommit/getanalysis', requestData, {
      headers: {
  ...
  return (
    <>
      ...
      <div className="main-con">
        {isLoading ? (
          <div className="loader">Please Wait While We Load Analysis For You.....</div>
        ) : (
          <>
          <canvas className="orb-canvas">
            ...
            <div className="main-container">
              <div className="main-container__inner">
                ...
                <button className="main-container__button main-container_button--transparent" onClick={fetchBranches}>
                  Fetch Branches
                </button>
                ...
                {flag ? (
                  <>
                    ...
                    <div className="main-container__buttons">
                      <button className="main-container__button" onClick={executeAnalysis}>
                        Execute
                      </button>
                    </div>
                  </>
              ...
              <div className="image_banner" style={{ display: "flex", justifyContent: "center", alignItems: "center" }}>
                <img src={banner} alt="My Image" style={{ width: "100%", height: "400px" }} />
              </div>
            </div>
          </>
        )}
